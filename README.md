...
## Enredo do Jogo:
  ...
  Ao longo do jogo de plataforma, os jogadores assumirão o controle dos personagens principais (selecionáveis), enfrentando desafios emocionantes em níveis inspirados por estádios icônicos, ruas movimentadas e  locais emblemáticos de TownSide.
...
- Os  Craques Sombrios - fases: Para além dos BOSS principais, o jogo terá inimigos que dificultarão a passagem dos heróis durante as fases de plataformas com suas habilidades, são ele, os craques sombrios.
...
- normalmente, o craque sombrio (Capuz) poderá ser derrotado tanto por carrinho ou se o personagem pular em cima dele, porem, um outro craque sombrio (sem capuz) só poderá ser derrotado por carrinho.
...
- Os jogadores não podem alternar entre os personagens principais durante o jogo. 
